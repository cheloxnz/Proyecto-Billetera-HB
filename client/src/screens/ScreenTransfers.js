...
import { SafeAreaView, View, FlatList, StyleSheet, Text, StatusBar,Alert, ScrollView, ImageBackground} from 'react-native';
                ...
                <View style={styles.contenedorPadre}> 
                    <View style={styles.contenedorCentral}>
                        <View style={styles.contenedorUp}>
                            ...
                            <Button
                                title="Has an account"
                                type="clear"
                                titleStyle={{ color: 'black', fontSize: 18 }}
                                containerStyle={{ marginVertical: 10, borderRadius: 10 }}
                                onPress = {() => {onlineUser?getAllContacts(onlineUser.id):console.log(onlineUser)}}
                            />
                            </View>
                            <View style={styles.contenedorNo}>
                            <Button
                                title="No account"
                                type="clear"
                                titleStyle={{ color: 'black', fontSize: 18 }}
